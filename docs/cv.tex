...
\section*{Experience}
\label{sec:org92d7eb5}
\subsection*{Research}
\label{sec:orgb9edf79}
\begin{footnotesize}
  \begin{tabular}{ll}
...
\label{sec:orge158285}
\subsection*{Conference Talks}
\label{sec:orgda41768}
\begin{enumerate}
...
\label{sec:org8f499d7}
Advanced R, intermediate Stata, basic SQL
\section*{Language}
\label{sec:orgbd72574}
