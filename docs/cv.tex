...
\section*{Experience}
\label{sec:orgc05cb8e}
\subsection*{Research}
\label{sec:org8153cda}
\begin{footnotesize}
  \begin{tabular}{ll}
...
\label{sec:orge7f87e0}
\subsection*{Conference Talks}
\label{sec:orgd20b1ca}
\begin{enumerate}
...
\label{sec:org81fab1e}
Advanced R, intermediate Stata, basic SQL
\section*{Language}
\label{sec:org1386278}
